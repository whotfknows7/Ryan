...
class ReactionHandler {
  static async handleReactionAdd(reaction, user) {
    ...
    try {
      ...
      if (roleConfig.isClanRole) {
        await this.handleClanRoleSwitch(guild, member, user, msgId, roleConfig.roleId, reactionRoles);
      }
  ...
  static async handleClanRoleSwitch(guild, member, user, currentMsgId, assignedRoleId, reactionRoles) {
