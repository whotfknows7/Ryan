...
const KeywordCommand = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub.setName('set').setDescription('Add/Update a keyword mapping').addStringOption(opt => opt.setName('keyword').setDescription('The trigger word').setRequired(true)).addStringOption(opt => opt.setName('emojis').setDescription('Emojis to react with (space separated)').setRequired(true)))
    .addSubcommand(sub => sub.setName('remove').setDescription('Remove a keyword mapping').addStringOption(opt => opt.setName('keyword').setDescription('The trigger word to remove').setRequired(true)))
