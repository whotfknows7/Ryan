...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub =>
      ...
      .addStringOption(opt => opt.setName('name').setDescription('Name of the role').setRequired(true).setMaxLength(32))
      .addStringOption(opt => opt.setName('color').setDescription('Hex color code (e.g. #FF0000)').setRequired(true))
      .addBooleanOption(opt => opt.setName('color_username').setDescription('Do you want this role to color your username?').setRequired(true))
    ),
